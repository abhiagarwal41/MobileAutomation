...
public class GeneralSteps {
	...
	@Given("^I start a log read thread searching for keyword \"([^\"]*)\"$")
	public void startThread(String searchKeyword) {
		logread = new Thread(new LogRunnable(searchKeyword));
		logread.start();
	}
